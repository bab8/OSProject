...
.switch:
    ...
    mov ah, 0x02
    mov al, 30 ; number of sectors to read from hard disk(if you specify more sectors than are actually present on physical device it will crash w/o err), increment by 1 til it works
    mov ch, 0x00
    mov dh, 0x00
    mov cl, 0x02
    int 0x13
