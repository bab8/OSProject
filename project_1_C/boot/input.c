...
//var used to call the assembly functions
extern unsigned int isr1, isr12;
//hold addresses to isr1, isr12
...
void InitialiseIDT(){
    ...
    //remaps interrupts into numbers
    RemapPIC();

    //specify PIC configuration, 00 are keyboard and mouse interrupts
...
void HandleISR1(){
    inportb(0x60);
    //acknowledge the interrupt is finished
    outportb(0xa0, 0x20);
    outportb(0x20, 0x20);
